...
export const settingsGroups: SettingGroup[] = [
  ...
  },
  {
    ...
    icon: "💾",
    description:
      "Redis server configuration and cache settings (optional - no defaults, configure only if using Redis)",
    enabled: true,
    requiresRestart: true,
    adminOnly: true,
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Rate Limit Secret",
        description: "Secret key for rate limiter cookie signing (auto-generated if empty)",
        type: "security",
        category: "private",
        sensitive: true,
      },
  ...
  },
  {
    ...
    icon: "🏢",
    description: "SAML 2.0 identity provider keys for enterprise single sign-on",
    enabled: true,
    requiresRestart: true,
    adminOnly: true,
    permissionId: "config:settings:saml",
    fields: [
      {
  ...
  },
  {
    ...
    icon: "🔐",
    description:
      "Third-party authentication providers (optional - no defaults, configure only if using OAuth)",
    enabled: true,
    requiresRestart: false,
    adminOnly: true,
    ...
    fields: [
      {
        ...
        description:
          "Enter your custom CSS here. This will be injected directly into your site's <head>.",
        type: "textarea",
        category: "public",
