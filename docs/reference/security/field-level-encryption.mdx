...
Application-Layer Encryption overhead was evaluated under an empirical benchmark suite (`tests/benchmarks/ale-encryption-impact.test.ts`) across 256 B, 4 KB, and 64 KB payloads. See the complete [ALE Benchmark Report](../../benchmarks/encryption_impact.mdx).
