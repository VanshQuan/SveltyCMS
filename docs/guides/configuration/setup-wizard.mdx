...
- **Map**: [E-Commerce Overview](../../reference/architecture/ecommerce-overview.mdx) — preset, importer, dashboard widgets, checkout pipeline, Stripe.
...
```
<Button onclick={testDatabaseConnection} disabled={isLoading} loading={isLoading}>
	{#if isLoading}
		Testing Connection...
	{:else}
